...
<s:form action="showSpecialtyByConditionAction.action" method="post">          
    ...
    <tr>
         ...
         <a href="selectSpecialtyByIdAction.action?id=<s:property value="id" />">查看</a>|
         <a href="selectSpecialtyForupdateAction.action?id=<s:property value="id" />">修改</a>|
         <a href="deleteSpecialtyByIdAction.action?id=<s:property value="id" />">删除</a></div></td>  
    </tr>      
    </s:iterator>
    </table> 
