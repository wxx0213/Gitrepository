...
<body>  
<a href="AddArchitectureAction.action">添加建筑信息</a> 
<s:form action="ShowBuildingByConditionAction.action" method="post">          
    ...
    <tr>
         ...
         <a href="selectforUpdateBuildingAction.action?id=<s:property value="buildId" />">修改</a>|
         <a href="deleteBuildingByIdAction.action?id=<s:property value="buildId" />">删除</a></div></td>  
    </tr>      
    </s:iterator>
    </table> 
