...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\">\r\n");
      out.write("    \r\n");
      out.write("    <title>My JSP 'forgetPassword.jsp' starting page</title>\r\n");
      out.write("    \r\n");
      ...
      out.write("  var password = document.getElementById(\"passwordID\").value; \r\n");
      out.write("  if (password.length < 6 || password.length > 18) { \r\n");
      out.write("   alert(\"请输入6-18位的密码\");\r\n");
      out.write("   document.getElementById(\"passwordID\").focus();\r\n");
      out.write("   check = false; \r\n");
      out.write("  } else if(reg.test(password)){\r\n");
      out.write("   alert(\"密码应含有字母和数字\");\r\n");
      out.write("   document.getElementById(\"passwordID\").focus();\r\n");
      out.write("   check = false; \r\n");
      out.write("  }\r\n");
      out.write("  else { \r\n");
      out.write("   document.getElementById(\"checktext2\").innerHTML = \"OK\"; \r\n");
      out.write("   check = true; \r\n");
      out.write("  } \r\n");
      out.write("  return check; \r\n");
      out.write(" }\r\n");
      out.write(" function checkpwdc() { \r\n");
      out.write("  var check; \r\n");
      out.write("  var password = document.getElementById(\"passwordID\").value; \r\n");
      out.write("  var pwdc = document.getElementById(\"repasswordID\").value; \r\n");
      out.write("  if (password != pwdc) { \r\n");
      out.write("   alert(\"两次密码输入的不一致\");\r\n");
      out.write("   document.getElementById(\"passwordID\").focus();\r\n");
      out.write("   check = false; \r\n");
      out.write("  } else { \r\n");
      out.write("   document.getElementById(\"checktext3\").innerHTML = \"OK\"; \r\n");
      out.write("   check = true; \r\n");
      out.write("  } \r\n");
      out.write("  return check; \r\n");
      out.write(" }\r\n");
  ...
  private boolean _jspx_meth_s_005fform_005f0(PageContext _jspx_page_context)
    ...
    // /resetPassword.jsp(64,5) name = action type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fform_005f0.setAction("UpdatePasswordAction.action");
    // /resetPassword.jsp(64,5) name = method type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fform_005f0.setMethod("post");
    // /resetPassword.jsp(64,5) name = cssClass type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fform_005f0.setCssClass("form-x");
    // /resetPassword.jsp(64,5) name = onsubmit type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_s_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("          <input type=\"password\" id=\"passwordID\"  name=\"newPassword\" maxlength=\"10\" onpaste=\"return false\" oncontextmenu=\"return false\" onchange=\"checkpwd()\"/>\r\n");
        out.write("          <div class=\"tips\"> <label id=\"checktext2\">请输入6位以上的密码</label><br/></div>\r\n");
        out.write("        </div>\r\n");
        out.write("      </div>     \r\n");
        out.write("      <div class=\"form-group\">\r\n");
        out.write("        <div class=\"label\">\r\n");
